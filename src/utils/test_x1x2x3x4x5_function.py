...
import wandb
from src.utils.hypercube_function_framework import HypercubeFunctionPredictor, run_hypercube_function_experiment
from src.utils.model import GPTConfig
from omegaconf import DictConfig

class test_x1x2x3x4x5_function():
    ...
    def fit(self):
        ...
        num_zero_tokens = self.cfg.num_zero_tokens
